...
const baseRoutes = [{
    ...
    meta: {
        ...
        isAffix: true,
        isIframe: false,
        roles: ['admin', 'investor', 'locationconf'],
...
// 					},
// 					{
// 						path: '/locationconf/detail',
// 						name: 'investedenterprisedetail',
// 						component: () => import('/@/views/locationconf/component/detail.vue'),
// 						meta: {
// 							title: '企业信息',
// 							isLink: '',
// 							isHide: true,
